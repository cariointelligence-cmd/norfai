...
sources / search quality / registers / hive / hakuketju / lähderekisteri /
intelligence layer / herätä henkiin / datapisteet / tyhjä tulos → **`fullstack-hive-intelligence-architect`**
(companion **`hive-system`** for layer names); DOM / overlay UI **including game chrome** → **`design-ui`**; game / canvas / 3D
