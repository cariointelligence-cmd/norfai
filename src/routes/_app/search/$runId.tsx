  ...
  const copy = loc(
    {
        ...
        queueWait: "Jonossa sija {n}. Maksavat ensin, odotus ei jää jumiin.",
        queueActive: "Tämä haku on ajossa.",
      },
      en: {
        ...
        queueWait: "Queue position {n}. Paid plans first; nobody waits forever.",
        queueActive: "This search is running.",
      },
      sv: {
        ...
        queueWait: "Köplats {n}. Betalande först, ingen fastnar.",
        queueActive: "Denna sökning körs.",
      },
    },
    locale,
  );
